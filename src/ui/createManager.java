   ...
   private ImageIcon staff = new ImageIcon(getClass().getResource("staff.png"));
    ...
    private String state;
       ...
       public createManager(){
        ...
        JLabel hint = new JLabel("MANAGER");
...
//        search.add(jtfstaffname);
      ...
      5, 5, Color.pink), "Manager Details", TitledBorder.LEFT, TitledBorder.TOP));
...
//       
//        staffSqnNo = Integer.parseInt(stafflatestID.substring(1));
//        staffSqnNo+=1;
...
//               jtfgender.setText("");
        ...
        private class AddListener implements ActionListener{
            public void actionPerformed(ActionEvent e){
              ...
              try{
                    if(jtfprivacyques.getText().equals("")){
                   ...
                   else if(jtfprivacyans.getText().equals("")){
                         JOptionPane.showMessageDialog(null,"Some fields are blank,please fill all the empty field before save it. ","Empty Field(s)",JOptionPane.WARNING_MESSAGE);
                    }
                ...
                ResultSet rs = selectRecord(staffid);
                     ...
                     if(rs.next()){
                         JOptionPane.showMessageDialog(null,"Manager id already exists","Please enter agaian",JOptionPane.ERROR_MESSAGE);
                     }
                     else{
