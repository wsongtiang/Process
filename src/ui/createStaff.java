...
//        basic.add(bottom);
       ...
       public void update(){
           ...
           int num = Integer.parseInt(laststaffid.charAt(3)+"");
           num++;
           String newstaffid = laststaffid.substring(0,3) + num;
           
           jtfstaffid.setText(newstaffid);
       }
...
//                int contact = Integer.parseInt(jtfcontact.getText());
//                int icno = Integer.parseInt(jtfic.getText());
//                int postcode = Integer.parseInt(jtfpostcode.getText());
...
//                    jtfgender.setText(rs.getString("gender"));
   ...
   createStaff frame = new createStaff();
}
}